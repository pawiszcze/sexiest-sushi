...
public class SpearProjectile : MonoBehaviour {
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.tag == "Foe")
        {
             ...
             * 
             */
            collision.gameObject.GetComponent<Foe>().attachedProjectiles.Add(this.gameObject);
            collision.gameObject.GetComponent<Foe>().GetDamaged(5, this.gameObject.GetComponent<Collider2D>());
