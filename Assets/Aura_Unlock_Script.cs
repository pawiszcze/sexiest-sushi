...
public class Aura_Unlock_Script : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    public Text textBox;
    ...
    private void SelectText()
    {
        switch (skillID)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                descriptionText = "Void Aura: Gives the projectiles a chance to be indused with Void Energy. Scares enemies off on hit or something.";
                break;
            case 5:
